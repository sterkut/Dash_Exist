...
with tab_history:
    ...
    if selected_indices:
        ...
        if root_prob == 'Немає': # Успіх / Замовлення
            res_bg, res_border, res_icon_bg, res_icon_color, res_icon = "#F0FDF4", "#BBF7D0", "#DCFCE7", "#16A34A", "✓"
            reason_html = ""
        elif "Відмова" in str(res_title) or root_prob in ['Менеджер', 'Ціна', 'Наявність', 'Термін поставки', 'Процес']: # Втрата клієнта
        ...
        else: # Нейтральні статуси ("Клієнт думає", "Сервісна консультація" тощо)
