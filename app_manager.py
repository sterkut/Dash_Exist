...
if not st.session_state.logged_in:
    ...
    st.stop() # Зупиняємо код для неавторизованих
...
# МАТЕМАТИКА ВТРАТ (Рахуємо недоотриманий потенціал угод)
...
tab_stats, tab_coach, tab_call = st.tabs(["🏆 Моя Ефективність", "🧠 Поради Тренера", "🎧 Аналіз моєї розмови"])
